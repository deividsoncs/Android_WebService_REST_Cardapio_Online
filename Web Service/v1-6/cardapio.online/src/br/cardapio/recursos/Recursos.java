...
public class Recursos {
	  ...
	  public List <Avaliacao> getAvaliacaoPorIdEstabelecimento(@PathParam("idEstabelecimento") long idEstabelecimento){
	  ...
	  public List <ItemCardapio> getitemPorIdEstabelecimento(@PathParam("idSecaoCardapio") long idSecaoCardapio){
	  ...
	  public List <SecaoCardapio> getSecaoCardapioPorIdCardapio(@PathParam("idCardapio") long idCardapio ){
	  ...
	  public List <Servicos> getSecaoListaServicoPorIdEstabelecimento(@PathParam("idEstabelecimento") long idEstabelecimento ){
	  ...
	  //Acesso: http://localhost:8080/cardapio.online/rest/recursos/remove_estabelecimento_servico/{idEstabelecimentoServico}
	  @GET
	  @Path("/remove_estabelecimento_servico/{idEstabelecimentoServico}")
	  @Produces(MediaType.TEXT_PLAIN)
	  public String removeEstabelecimentoServico(@PathParam("idEstabelecimentoServico") long idEstabelecimentoServico){
		  return new EstabelecimentoServicoBusiness().remove(idEstabelecimentoServico);
	  }
	  ...
	  //Acesso: http://localhost:8080/cardapio.online/rest/recursos/remove_tipo_estabelecimento_estabelecimento/{idTipoEstabelelcimento}
	  @GET
	  @Path("/remove_tipo_estabelecimento_estabelecimento/{idTipoEstabelelcimento}")
	  @Produces(MediaType.TEXT_PLAIN)
	  ...
	  public List <TipoEstabelecimento> getSecaoListaTipoEstabelecimentoPorIdEstabelecimento(@PathParam("idEstabelecimento") long idEstabelecimento ){
	  ...
	  //Acesso: http://localhost:8080/cardapio.online/rest/recursos/remove_estabelecimento_tipo/{idEstabelecimentoTipo}
	  @GET
	  @Path("/remove_estabelecimento_tipo/{idEstabelecimentoTipo}")
	  @Produces(MediaType.TEXT_PLAIN)
	  public String removeEstabelecimentoTipoEstabelecimento(@PathParam("idEstabelecimentoTipo") long idEstabelecimentoTipo){
		  return new EstabelecimentoTipoEstabelecimentoBusiness().remove(idEstabelecimentoTipo);
	  }
