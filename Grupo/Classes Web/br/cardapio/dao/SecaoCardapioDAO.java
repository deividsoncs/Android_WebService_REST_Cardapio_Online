...
public class SecaoCardapioDAO {
	...
	public void remove(long idSecaoCardapio) {
	     try {
	    	 Connection conn = (Connection) Conexao.getConexao();
	         PreparedStatement stmt = (PreparedStatement) conn.prepareStatement("DELETE FROM bd_cardapio.secao_cardapio where id=?");
	...
	public SecaoCardapioList getListaSecaoPorIdCardapio(long idCardapio) {
		try {
			SecaoCardapioList listaCardapio = new SecaoCardapioList();      
	         Connection conn = (Connection) Conexao.getConexao();
